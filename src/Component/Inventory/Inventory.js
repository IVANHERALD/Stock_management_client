...
function Inventory() {
    ...
    // Function to fetch stock data based on page number
    ...
    const handleStockDelete = async (item) => {
        try {
            ...
            if (response.ok) {
                ...
                loadStock(); // Reload stock after deletion
            } else {
    ...
    return (
        <div>
            <div className='button_add'>
                <Button variant='outlined' endIcon={<AssignmentTurnedInOutlinedIcon />} sx={{ backgroundColor: '#17BBC0', color: '#FFFFFF', borderColor: '#333333', ':hover': { backgroundColor: '#17BBC0', color: '#FFFFFF', borderColor: '#333333' } }} onClick={mailVendor}>PLACE ORDER</Button>
                <Button variant='outlined' endIcon={<ControlPointSharpIcon />} sx={{ backgroundColor: '#17BBC0', color: '#FFFFFF', borderColor: '#333333', ':hover': { backgroundColor: '#17BBC0', color: '#FFFFFF', borderColor: '#333333' } }} onClick={addProduct}>ADD NEW PRODUCT</Button>
            </div>
